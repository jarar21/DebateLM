...
def process_documents(uploaded_files):
    ...
    # 1. OPTIMIZED CHUNK SIZES (Gemini has a massive context window, 400 is too small)
    # This reduces the total chunks generated by 60-70%
    p_split = RecursiveCharacterTextSplitter(chunk_size=3000, chunk_overlap=300)
    c_split = RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=100)
    ...
    for uf in uploaded_files:
        ...
        # 2. USE PyMuPDFLoader (10x faster than PyPDFLoader)
    ...
    for parent in parent_docs:
        ...
        for child in children:
            ...
            # Remove complex source formatting that Pinecone metadata struggles with
    ...
    # 4. SMARTER BATCHING
    # Langchain and Gemini can comfortably handle 200-250 chunks at a time
    BATCH_SIZE = 200 
